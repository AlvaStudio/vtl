...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Vitalium " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"vitalium.site", "node.vitalium.site"},
    {NULL, NULL}
};
...
// 0x0100007f, 0x0100007f, 0x0100007f ....
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Vitalium is probably already running."), addrBind.ToString().c_str());
        else
